...
urlpatterns = [
    ...
    path('team/<int:team_id>/add_member/', views.add_member_to_team, name='add_member_to_team'),
    ...
    path('managers/', views.manager_list, name='manager_list'),  # Added URL pattern for manager list
